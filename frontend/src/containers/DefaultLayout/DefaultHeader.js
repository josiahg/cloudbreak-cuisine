      ...
      <React.Fragment>
        ...
        <Nav className="ml-auto" navbar>
          <AppHeaderDropdown direction="down">
            <DropdownToggle nav>
              <img src={'../../assets/img/avatars/1.png'} className="img-avatar" alt="admin@cloudera.com" /> admin@cloudera.com &nbsp; &nbsp;
            </DropdownToggle>
            <DropdownMenu style={{ right: 'auto' }}>
              <DropdownItem href="#/profiles/1"><i className="fa fa-cloud"></i> Profile</DropdownItem>
