...
class ZeppelinNotes extends Component {
    ...
    render() {
        ...
        return (
            <div className="animated fadeIn align-items-center">
                <Row>
                    <Col>
                        <h1>Available Zeppelin Notes</h1>

                    </Col>
                    <Col align="right" >
                        <div >
                            <Button size="lg" color="success" href="#/addzeppelinnote">
                                ...
                                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                                    ...
                                    <tbody>
                                        ...
                                        {serviceList.map((service) => {
                                            ...
                                            const associatedRecipes = recipesData.filter((recipe) => ((recipe.display === 1) && (recipe.serviceId === service.id) && (recipe.addon_type === "Zeppelin Note")))
